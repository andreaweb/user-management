  ...
  render() {
    return (
      <main className="home">
        ...
        All you can do is include users and groups, but they&lsquo;ll disappear as soon as 
        the page is refreshed. <br/><br/> Since I don&lsquo;t connect to a &lsquo;real&lsquo; API, 
        I&lsquo;d have stored values locally if I had enough time.
        If there was another way to do this through the front-end, please let me know!<br/><br/>
